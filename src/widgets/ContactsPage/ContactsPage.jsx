...
export const ContactsPage = () => {
    const { phone_numbers, emails, error, address, google_map_address, open_hours, isLoading } = useFooterStore();
                ...
                <div className={styles.contacts}>
                    <div className={styles.time}>
                        ...
                        <div className={styles.text}>
                            ...
                            <Typography variant="bodyL" color="white" weight="regular">{ open_hours}</Typography>
                        </div>
                    </div>
                    ...
                    <div className={styles.phone}>
                        ...
                        <div className={styles.text}>
                            ...
                            {phone_numbers.map((phone) => (
                                <Typography variant="bodyL" weight="regular" color="white" key={phone.id}>
                    ...
                    <div className={styles.email}>
                        ...
                        <div className={styles.text}>
                            ...
                            {emails.map((item, index) => (
                                <Typography variant="bodyL" weight="regular" color="white" key={index}>
                                    {item.email}
                                </Typography>
                            ))}
                        </div>

...
export function AboutUs() {
    return (
        <div>
            <Typography variant = 'h3' weight = 'bold'>О нас </Typography>

            <img src={aboutUs}/>

            <Typography variant = 'p' styleType = 'Medium' weight = 'regular'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
